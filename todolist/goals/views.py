...
from todolist.goals.permissions import BoardPermissions, GoalCategoryPermissions, IsOwnerOrReadOnly, GoalPermissions
...
class BoardCreateView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        """Делаем текущего пользователья владельцем доски"""
